...
<head>
	...
	<title><?php echo $joke['title']; ?></title>
		...
		<header class="wrapper">
			...
			<nav>
				<ul>
					...
					<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=new">add a joke</a></li>
	...
	<div id="main" class="wrapper">
		<article>
			<header>
				...
				<p><?php $text=str_replace("\n","<br />\n",$joke['text']); echo $text; ?></p>
			</header>
			<h3>Category: <?php 
foreach($joke['category'] as $category) {
	echo " \"".$category['name']."\"";
} ?></h3>
			<p><a href="<?php echo $_SERVER['PHP_SELF']; ?>">Tell another one</a></p>
			</div>
		</article>
	</div>
